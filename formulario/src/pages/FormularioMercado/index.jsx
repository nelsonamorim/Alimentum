import './style.css';
import logoAlimentum from './assets/img/logoAlimentum.png';
import iconX from './assets/img/iconX.png';
import barraDeProgresso from './assets/img/progressBar.png';
  ...
  <div className="container">
    ...
    <form className="form-cadastro__parceiro" method="post" action="">
      ...
      <div className="notification">
        <img src="./FormularioMercado/assets/img/cadeado.png" alt="" />
        <p>
        ...
        <img src="./assets/img/iconXPequeno.png" alt="" />
      </div>
